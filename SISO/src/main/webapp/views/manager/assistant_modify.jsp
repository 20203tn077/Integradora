    ...
    <c:if test="${access}">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <nav class="navbar-nav">
                        ...
                        <a class="nav-link active" href="${context}/Gestión_de_Auxiliares?redirect=assistants">Gestión de auxiliares</a>
        ...
        <div class="container mt-4">
            <div class="card shadow-sm">
                <h5 class="card-header">Modificar datos de auxiliar</h5>
                <div class="card-body">
                    <form action="${context}/Gestión_de_Auxiliares" method="POST" class="m-0" id="mainForm">
                        <input type="hidden" name="action" value="modifyAssistant">
                        <input type="hidden" name="id" value="${assistant.id_user}">
                        <div class="row gy-3">
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Nombre de usuario:</label>
                                <input type="text" class="form-control" id="usernameInput" name="usernameInput" value="${assistant.nameUser}" autocomplete="off" maxlength="20" required>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Nombre(s):</label>
                                <input type="text" class="form-control" id="nameInput" name="nameInput" value="${assistant.name}" autocomplete="off" maxlength="25" required>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Primer apellido:</label>
                                <input type="text" class="form-control" id="lastname1Input" name="lastname1Input" value="${assistant.lastname1}" autocomplete="off" maxlength="25" required>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Segundo apellido (opcional):</label>
                                <input type="text" class="form-control" id="lastname2Input" name="lastname2Input" value="${assistant.lastname2}" autocomplete="off" maxlength="25">
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <label class="form-label">Correo electrónico:</label>
                                <input type="email" class="form-control" id="emailInput" name="emailInput" value="${assistant.email}" autocomplete="off" maxlength="60" required>
                            </div>
                        </div>
                        <hr>
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <input type="password" class="form-control" autocomplete="off" maxlength="30" minlength="8" id="passwordConfirmation">
                            </div>
                        </div>
                    </form>
                </div>
