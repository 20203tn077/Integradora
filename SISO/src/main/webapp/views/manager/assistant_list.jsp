                            ...
                            <tbody>
                                <c:forEach items="${assistantList}" var="assistant">
                                    <tr role="button">
                                        ...
                                        <td>${assistant.name.concat(" ").concat(assistant.lastname1).concat(" ").concat(assistant.lastname2)}</td>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <form action="${context}/SISO_war/ServletRecords" method="POST" target="_blank" class="m-0">
