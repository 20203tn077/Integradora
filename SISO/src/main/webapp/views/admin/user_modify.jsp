                ...
                <form action="" method="get">
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <input type="email" class="form-control" id="usernameInput" required>
                        </div>
                        <div class="col-md-6 col-xl-4 mb-3">
                            <label for="usernameInput" class="form-label">Rol:</label>
                            <select class="form-select" aria-label="Default select example">
                                <option selected>Seleccione un rol...</option>
                                <option value="1">Auxiliar</option>
                                <option value="2">Responsable de departamento</option>
                                <option value="3">Responsable de la oficialía de partes</option>
                            </select>
                        </div>
                        <div class="col-md-6 col-xl-4 mb-3">
                            <label for="usernameInput" class="form-label">Departamento:</label>
                            <select class="form-select" aria-label="Default select example">
                                <label for="usernameInput" class="form-label">Departamento:</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <input type="password" class="form-control" id="usernameInput" required>
                        </div>
                        <div class="col-md-6 col-xl-4 mb-3">
