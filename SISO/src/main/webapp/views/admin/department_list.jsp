...
<body class="bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <nav class="navbar-nav">
                        ...
                        <a class="nav-link active"
                            href="${context}/Gestión_de_Departamentos?redirect=departments">Gestión de departamentos</a>
                        ...
                        <tbody class="align-middle">
                            <c:choose>
                                <c:when test="${empty departmentList}">
                                    <td colspan="3">Sin departamentos</td>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach items="${departmentList}" var="department">
                                        <tr role="button" onclick="showModalDetails('${department.idDepartment}')">
                                            <td>
                    ...
                    <div class="modal-footer">
                        <div class="row w-100">
                            <div class="p-1 col-md-6 col-lg-4">
                                <form action="${context}/Modificar_Departamento" method="post" class=" d-inline m-0">
                                    <input type="hidden" name="action" value="redirect">
                                    <input type="hidden" name="redirect" value="departmentModify">
                                    ...
                                    <button type="submit" class="btn btn-verde w-100">
                                        ...
                                        <span> Modificar departamento</span>
                                    </button>
                                </form>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="row w-100">
                            ...
                            <div class="p-1 col-md-6 col-lg-4">
                                <form action="${context}/Gestión_de_Departamentos" method="post" class="d-inline m-0">
    ...
    <script src="${context}/assets/js/admin/departmentListUtil.js"></script>
</body>
