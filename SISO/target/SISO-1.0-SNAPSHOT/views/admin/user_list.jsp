            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <nav class="navbar-nav">
                        <a class="nav-link active" href="${context}/Gestión_de_Usuarios?redirect=users">Gestión de
                            usuarios</a>
                        <a class="nav-link" href="${context}/Gestión_de_Departamentos?redirect=departments">Gestión de
                            departamentos</a>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${userList}" var="user">
                                        <tr role="button" onclick="showModalDetails('${user.id_user}')">
                                            <td>${user.nameUser}</td>
                                            <td>${user.name.concat(" ").concat(user.lastname1).concat("
                                                ").concat(user.lastname2)}</td>
